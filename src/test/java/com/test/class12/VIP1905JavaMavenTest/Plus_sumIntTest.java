...
public class Plus_sumIntTest {
	...
	public Plus_sumIntTest(String caseName, String expected, int param1, int param2) {
		n = param1;
		m = param2;
	...
	@Parameters(name = "测试Plus_IntSum_{0}测试")
